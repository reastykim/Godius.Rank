        ...
        public static string GetPosisionImage(GuildPositions guildPosition)
        {
            ...
            switch (guildPosition)
            {
                case GuildPositions.Master:
                    return $"<img src='images/positions/0.jpg' alt='{displayName}' class='img-responsive' />";
                case GuildPositions.SubMaster:
                    return $"<img src='images/positions/4.jpg' alt='{displayName}' class='img-responsive' />";
                case GuildPositions.Journeyman:
                    return $"<img src='images/positions/1.jpg' alt='{displayName}' class='img-responsive' />";
                case GuildPositions.Apprentice:
                    return $"<img src='images/positions/2.jpg' alt='{displayName}' class='img-responsive' />";
                case GuildPositions.Newbie:
                default:
                    return $"<img src='images/positions/3.jpg' alt='{displayName}' class='img-responsive' />";
            }
